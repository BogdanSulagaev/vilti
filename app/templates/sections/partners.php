    ...
    <div class="container">
        <div class="partners__content">
            <div class="head-content fade-in-up">
                <h2 class="title title--h2">Создаём вместе будущее <br>элитной недвижимости</h2>
                ...
                <div class="info-card info-card--1 fade-in-up info-card--large">
                    ...
                    <div class="info-card__text">
                        ...
                        <ul>
                            ...
                            <li>Авторский надзор на&nbsp;всех этапах реализации </li>
                            <li>Совместная презентация проектов клиентам </li>
                            <li>Приоритетный статус в&nbsp;очереди проектов </li>
                            <li>Техническая поддержка при проектировании </li>
                        </ul>
                    </div>
                </div>
                <div class="info-card info-card--2 fade-in-up info-card--large">
                    ...
                    <div class="info-card__text">
                        ...
                        <ul>
                            ...
                            <li>Координация инженерных решений под дизайн </li>
                            <li>Совместное планирование этапов отделки </li>
                            <li>Рекомендация клиентам ваших услуг </li>
                            <li>Скидки на&nbsp;материалы через наших поставщиков </li>
                        </ul>
                    </div>
                </div>
                <div class="info-card info-card--3 fade-in-up info-card--large">
                    ...
                    <div class="info-card__text">
                        ...
                        <ul>
                            ...
                            <li>Индивидуальные коммерческие предложения </li>
                            <li>Участие в&nbsp;тендерах и&nbsp;конкурсах </li>
                            <li>Консультации по&nbsp;технологиям строительства </li>
                            <li>Совместный маркетинг проектов </li>
                        </ul>
                    </div>
                </div>
            </div>
